    ...
    while(True):
        ...
        if(orientation!=None):#当前朝向信息获取后
            ...
            if(body_segment_response.result=="success"):
                ...
                print("distance")
                rospy.sleep(0.1)
                # print("daodaweizhi the position is:/n")
                # print(target)
        # if(abs(mean_distance-dzhiding)<=0.05):
        #     if(body_segment_response.cX>=280):
        #         if(body_segment_response.cX<=340):
        #             break
